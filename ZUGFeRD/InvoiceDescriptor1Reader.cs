...
namespace s2industries.ZUGFeRD
{
    internal class InvoiceDescriptor1Reader : IInvoiceDescriptorReader
    {
        ...
        public override InvoiceDescriptor Load(Stream stream)
        {
            ...
            {
                TypeCode = EnumExtensions.StringToEnum<PaymentMeansTypeCodes>(XmlUtils.NodeAsString(doc.DocumentElement, "//ram:ApplicableSupplyChainTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans/ram:TypeCode", nsmgr)),
        ...
        private static TradeLineItem _parseTradeLineItem(XmlNode tradeLineItem, XmlNamespaceManager nsmgr = null)
        {
            ...
            TradeLineItem item = new TradeLineItem(lineId)
            {
                ...
                NetUnitCode = default(QuantityCodes).FromString(XmlUtils.NodeAsString(tradeLineItem, ".//ram:NetPriceProductTradePrice/ram:BasisQuantity/@unitCode", nsmgr)),
                ...
                GrossUnitCode = default(QuantityCodes).FromString(XmlUtils.NodeAsString(tradeLineItem, ".//ram:GrossPriceProductTradePrice/ram:BasisQuantity/@unitCode", nsmgr)),
