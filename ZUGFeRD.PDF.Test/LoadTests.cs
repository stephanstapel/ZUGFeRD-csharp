...
namespace ZUGFeRD.PDF.Test
{
    ...
    public sealed class LoadTests
    {
        ...
        public async Task BasicLoadExampleFile()
        {
            ...
            InvoiceDescriptor desc = await InvoiceDescriptorPdfExtension.LoadFromPdfAsync(path);
        ...
        public async Task BasicLoadNonExistingFile()
        {
            ...
            await Assert.ThrowsExceptionAsync<FileNotFoundException>(() => InvoiceDescriptorPdfExtension.LoadFromPdfAsync(path));
