...
namespace s2industries.ZUGFeRD.Test
{
    ...
    public class ZUGFeRD22Tests : TestBase
    {
        ...
        **/
        ...
        [DataRow(Profile.Extended)]
        [DataRow(Profile.XRechnung)]
        public void TestTaxTotalAmountBT110SingleCurrency(Profile profile)
        {
            InvoiceDescriptor desc = _InvoiceProvider.CreateInvoice();
        ...
        [DataRow(Profile.Comfort)]
        [DataRow(Profile.Extended)]
        public void TestTaxTotalAmountBT110AndBT111DualCurrency(Profile profile)
        {
            InvoiceDescriptor desc = _InvoiceProvider.CreateInvoice();
        ...
        /// </summary>
        [TestMethod]
        public void TestTaxTotalAmountBT110OnlyWhenTaxCurrencyEqualsCurrency()
        {
            InvoiceDescriptor desc = _InvoiceProvider.CreateInvoice();
